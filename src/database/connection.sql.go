...
type UpdateConnectionRow struct {
	ID              pgtype.UUID        `json:"id"`
	UserID          pgtype.UUID        `json:"user_id"`
	ProviderID      string             `json:"provider_id"`
	EncryptedApiKey string             `json:"encrypted_api_key"`
...
func (q *Queries) UpdateConnection(ctx context.Context, arg UpdateConnectionParams) (UpdateConnectionRow, error) {
